...
date=`date +%Y%m%d`
outputname="$romtypename-$outputtype-$sourcever-$date-Nguyenhung9xdev"
...
sed -i "s/$bdisplay/$displayid2=Built\.by\.@nguyenhung9xdev\.with\.ErfanGSI\.Tools/" $systemdir/system/build.prop
